...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.0957}}
  >{\centering\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.1277}}
  >{\centering\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.1383}}
  >{\centering\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.0851}}
  >{\centering\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.0851}}
...
Yaganes. TL: Trophic Level; KSI: Keystone Species Index. TaxLevel:
Taxonomic Level. Ordered by the KSI.}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Species
