...
pandoc.table(sp_tbl %>% arrange(., (IEC)) %>% 
             ...
             caption = "List of species for the food web of the Marine Protected Area Yaganes. TotDegree: total degree; TL: Trophic Level; KSI: Keystone Species Index. TaxLevel: Taxonomic Level. Ordered by the KSI.")
...
pandoc.table(dist_fit$models %>% 
               arrange(., (AIC)) %>% 
               dplyr::select(AIC, BIC, model, family) %>% 
