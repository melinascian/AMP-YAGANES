...
pandoc.table(sp_tbl %>% arrange(., (IEC)) %>% 
               ...
               rename("Species"="name", "Degree"="degree.total", "Closeness"="closeness", "Betweeness"="betweeness", "KSI"="IEC"), style="multiline", split.tables = Inf, justify = c("left","center","center","center","center","center"),
             caption = "List of species for the food web of the Marine Protected Area Yaganes. TL: Trophic Level; KSI: Keystone Species Index. Ordered by the KSI.")
